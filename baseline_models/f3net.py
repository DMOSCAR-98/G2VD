"""
F3Net baseline adapted for detection; use BaselineModelWrapper with BTCHW video input.
...
pretrained_settings = {
    'xception': {
        'imagenet': {
            'dir': './pretrained_weights/xception-b5690688.pth',
...
def return_pytorch04_xception(pretrained=True):
    ...
    if pretrained:
        ...
        state_dict = torch.load(
            './pretrained_weights/xception-b5690688.pth',
            map_location='cpu',
            weights_only=False,
        )
